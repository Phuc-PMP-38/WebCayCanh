          ...
          <div class="row">
             <div class="col-sm-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
                    <div class="logo">
                   <a href="index.php"><img src="img/logocaycanh.png" alt="bstore logo" /></a>
               </div>
                </div>
               ...
               <div class="categorys-product-search">
                <form action="search.php" method="GET" class="search-form-cat" >
                    <div class="search-product form-group">
                        <input type="text" class="form-control search-form" name="ten_sp" placeholder="Nhập Tên Cây cảnh ... " required />
